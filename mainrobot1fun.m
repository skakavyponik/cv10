% hladanie kociek robotom v bludisku s prekazkami,
...
%robot=[poziciaX poziciaY snimacLavo snimacPravo snimacVpred pohyb otocenie smer zoberkocku prekazka cielx ciely offset_rand gain_rand]
...
% hlavna funkcia
function [caszberu]=mainrobot1fun(pocetkociek,pocetprekazok)
